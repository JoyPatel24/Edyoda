...
class Foodorder():
    def admin(self):
        ad=["add items","change price","change discount","add items by food_ID","remove items by food_ID",
            "view list","stock left"]
        print("star","operation")
        for i,j in enumerate(ad,start=1):
            print(i,j)
